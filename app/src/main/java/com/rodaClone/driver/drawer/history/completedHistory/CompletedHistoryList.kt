...
import com.rodaClone.driver.databinding.FragmentCompletedHistoryListBinding
import com.rodaClone.driver.drawer.history.HistoryFragmentDirections
import com.rodaClone.driver.drawer.history.adapter.HistoryAdapter
...
//        }
    ...
    private fun setupAdapter() {
        adapter =
            vm.translationModel?.let {
                HistoryAdapter(ArrayList(), vm.session,vm.getNavigator(),
                    it
                )
            }
        val mLayoutManager =
